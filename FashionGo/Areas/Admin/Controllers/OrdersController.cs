...
namespace FashionGo.Areas.Admin.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var orders = db.Orders.Include(o => o.OrderStatus).Include(o => o.PaymentMethod).Include(o => o.Transport).Include(o => o.User).Where(x => x.StatusId != 4).ToList();
            return View(orders);
        }
        public ActionResult Ordercompleted()
        {
            var orderscompleted = db.Orders.Include(o => o.OrderStatus).Include(o => o.PaymentMethod).Include(o => o.Transport).Include(o => o.User).Where(x => x.StatusId == 4).ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,StatusId,Coupon,Discount,ExtraDiscount,TotalAmount,TransportId,PaymentMethodId,ReceiveName,ReceiveAddress,ReceivePhone,Note,OrderDate,RequireDate,TotalOrder")] Order order)
        {
            if (ModelState.IsValid)
            {
